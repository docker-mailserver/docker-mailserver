...
run:
  ...
  ifneq (,$(filter mail_pop3,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_smtponly,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_smtponly_without_config,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_fail2ban,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_fetchmail,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_manual_ssl,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_with_ldap,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_with_imap,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_postscreen,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_with_postgrey,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_undef_spam_subject,$(CONTAINER)))
  ...
  ifneq (,$(filter mail_with_relays,$(CONTAINER)))
