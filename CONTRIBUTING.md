...
6. Document your improvements if necessary (e.g. if you introduced new environment variables, write the description in [`the documentation`](./docs/content/config/environment.md))
