...
@test "substitue key value pair (01) (simple)" {
  export TEST_KEY_1='new_value_1'
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (02) (complex 1)" {
  export TEST_KEY_1='(&(objectClass=PostfixBookMailAccount)(|(uniqueIdentifier=%n)(mail=%u)))'
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (03) (complex 2)" {
  export TEST_KEY_1="*+=/_-%&"
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (04) (complex 3)" {
  export TEST_KEY_1='(&(objectClass=mailAccount)(uid=%n))'
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (05) (complex 4)" {
  export TEST_KEY_1='=home=/var/mail/%{ldap:mail}, =mail=maildir:/var/mail/%{ldap:mail}/Maildir'
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (06) (complex 5)" {
  export TEST_KEY_1='(&(objectClass=mailAccount)(uid=%n))'
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (07) (complex 6)" {
  export TEST_KEY_1='uid=user,userPassword=password'
  _do_work "key_1 = ${TEST_KEY_1}"
}

@test "substitue key value pair (08) (no value in file)" {
  export TEST_KEY_2='new_value_2'
  _do_work "key_2 = ${TEST_KEY_2}"
}

@test "substitue key value pair (09) (no space at value)" {
  export TEST_KEY_3='new_value_3'
  _do_work "key_3 = ${TEST_KEY_3}"
}

@test "substitue key value pair (10) (no space at key)" {
  export TEST_KEY_4="new_value_4"
  _do_work "key_4 = ${TEST_KEY_4}"
}

@test "substitue key value pair (11) (no space at key and value)" {
  export TEST_KEY_5="new_value_5"
  _do_work "key_5 = ${TEST_KEY_5}"
}

@test "substitue key value pair (12) (no value of variable)" {
  export TEST_KEY_6=
  _do_work "key_6 ="
