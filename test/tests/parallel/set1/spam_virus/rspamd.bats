...
function setup_file() {
  ...
  export MAIL_ID1=$(_send_mail_and_get_id 'email-templates/existing-user1')
  export MAIL_ID2=$(_send_mail_and_get_id 'email-templates/rspamd-spam')
  export MAIL_ID3=$(_send_mail_and_get_id 'email-templates/rspamd-virus')
