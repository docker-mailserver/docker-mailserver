...
function create_lock
{
    ...
    [[ ! -e "${LOCK_FILE}" ]] && errex "Lock file ${LOCK_FILE} could not be created. Please ensure that /tmp/docker-mailserver (or the location you've mounted to that from the host) is writable."
}
