...
VARS[ENABLE_PER_USER_STORAGE_ENCRYPTION]="${ENABLE_PER_USER_STORAGE_ENCRYPTION:=0}"
VARS[PER_USER_STORAGE_ENCRYPTION_CURVE]="${PER_USER_STORAGE_ENCRYPTION_CURVE:=secp521r1}"
VARS[PER_USER_STORAGE_ENCRYPTION_SCHEME]="${PER_USER_STORAGE_ENCRYPTION_SCHEME:=CRYPT}"
