...
- Postfix `master.cf` has renamed the "smtps" service to "submissions". This is the modern `/etc/services` name for port 465, aligning with the similar "submission" port 587. ([#3235](https://github.com/docker-mailserver/docker-mailserver/pull/3235))
- Dovecot mail storage per account in `/var/mail` previously shared the same path for the accounts home directory. The home directory now is a subdirectory `home/`. This change better supports sieve scripts, however the change has not yet been implemented for `ACCOUNT_PROVISIONER=LDAP`. ([#3335](https://github.com/docker-mailserver/docker-mailserver/pull/3335))
...
- Allow DSN (_Delivery Status Notification_) in Postfix only on authenticated ports (465 + 587) ([#3572](https://github.com/docker-mailserver/docker-mailserver/pull/3572))
...
- Added checks and warnings for when `CLAMAV_MESSAGE_SIZE_LIMIT` exceeds internal limits of ClamAV (4GiB max scan size [#3332](https://github.com/docker-mailserver/docker-mailserver/pull/3332), 2GiB max file size [#3341](https://github.com/docker-mailserver/docker-mailserver/pull/3341))
...
- **Documentation:**
  ...
  - The debugging page now has a compatibility section ([#3404](https://github.com/docker-mailserver/docker-mailserver/pull/3404))
  ...
  - New use-case example documents iOS mail push support ([#3513](https://github.com/docker-mailserver/docker-mailserver/pull/3513))
...
- `setup fail2ban` gained a new `status <JAIL>` subcommand ([#3455](https://github.com/docker-mailserver/docker-mailserver/pull/3455))
- Added `RSPAMD_CHECK_AUTHENTICATED` environment variable. Allows authenticated users to avoid additional security checks by Rspamd ([#3440](https://github.com/docker-mailserver/docker-mailserver/pull/3440))
...
- Allow changing the Dovecot vmail UID/GID (_default `5000:5000` / `docker:docker`_) via new ENV `DMS_VMAIL_UID` and `DMS_VMAIL_GID` ([#3550](https://github.com/docker-mailserver/docker-mailserver/pull/3550))
- Add debug group to `packages.sh` ([#3578](https://github.com/docker-mailserver/docker-mailserver/pull/3578))
- New use-case example guide for setting up Dovecot Lua authentication, with additional `dovecot-auth-lua` package to support it ([#3579](https://github.com/docker-mailserver/docker-mailserver/pull/3579))
...
- **Rspamd:**
  ...
  - Now more resilient setup during container startup ([#3578](https://github.com/docker-mailserver/docker-mailserver/pull/3578))
  ...
  - Check permissions are correct for DKIM private key files ([#3627](https://github.com/docker-mailserver/docker-mailserver/pull/3627))
...
- **Documentation:**
  ...
  - Complete rewrite of the IPv6 page ([#3244](https://github.com/docker-mailserver/docker-mailserver/pull/3244))
  ...
  - Fixed IPv6 example for Compose ([#3531](https://github.com/docker-mailserver/docker-mailserver/pull/3531))
  - Revised the "Update and Cleanup" maintenance page ([#3539](https://github.com/docker-mailserver/docker-mailserver/pull/3539), [#3583](https://github.com/docker-mailserver/docker-mailserver/pull/3583))
...
- clarify that the issue tracker is not for personal support ([#3498](https://github.com/docker-mailserver/docker-mailserver/pull/3498), [#3502](https://github.com/docker-mailserver/docker-mailserver/pull/3502))
...
- Dropped special bits from Postfix `maildrop/` and `public/` directory permissions ([#3625](https://github.com/docker-mailserver/docker-mailserver/pull/3625))
...
- Fixed scheduled build permissions ([#3345](https://github.com/docker-mailserver/docker-mailserver/pull/3345))
