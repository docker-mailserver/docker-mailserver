...
- When `ENABLE_GETMAIL=1` the expected state directory `/var/lib/getmail/` is now created for the Getmail service ([#4018](https://github.com/docker-mailserver/docker-mailserver/pull/4018))
